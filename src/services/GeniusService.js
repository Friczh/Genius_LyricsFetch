 ...
 * GET /api/search/multi?per_page=1&q={query}
 * Returns first hit: { id, title, artistNames }
 */
...
/**
 * Step 2: Fetch plain lyrics by song ID
 * GET /api/songs/{id}
 * Returns: song.lyrics.plain (clean plain text, no HTML)
 */
